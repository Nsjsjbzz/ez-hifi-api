...
TOKEN_FILE = Path(os.getenv("TOKEN_FILE", Path(__file__).resolve().parent.parent / "token_hifi.json"))
...
CLIENT_ID = base64.b64decode("OEt5N0lRQXoyQVZudXk0eA==").decode("iso-8859-1")
